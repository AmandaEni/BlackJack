...
while hand_value_2 < 17:
  ...
  hand_value_2 += card_value
  if num_cards > 1 and hand_value_2 < 17:
    print("Dealer has {}.".format(hand_value_2))

print("Final hand: " + str(hand_value_2) + ".")
if hand_value_2 == 21:
    print("BLACKJACK!")
...
print ('GAME RESULT')
print ('-----------')
#Game results will be evaluated here
